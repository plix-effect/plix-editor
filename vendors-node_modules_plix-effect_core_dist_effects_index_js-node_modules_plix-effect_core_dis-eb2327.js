...
/***/ "./node_modules/@plix-effect/core/dist/effects/FillHSLA.js":
/*!*****************************************************************!*\
  !*** ./node_modules/@plix-effect/core/dist/effects/FillHSLA.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
FillHSLA.meta = {
    name: "FillHSLA",
    description: "Fill with color generated by (h,s,l,a) values",
    paramNames: ["hue", "saturation", "lightness", "alpha"],
    paramTypes: ["timing", "timing", "timing", "timing"],
    paramDescriptions: ["hue (0-1)", "saturation (0-1)", "lightness (0-1)", "alpha (0-1)"],
    defaultValues: [["step", 0, 10, 0.1], ["linear", 0.5, 1], 0.5, 1],
    paramParse: [parseTypes_1.TIMING_FUNCTION, parseTypes_1.TIMING_FUNCTION, parseTypes_1.TIMING_FUNCTION, parseTypes_1.TIMING_FUNCTION]
};
function FillHSLA(fh, fs, fl, fa) {
    return function (time, duration) {
        var dt = time / duration;
        var color = Color_1.fromHsla({
            h: posMod_1.default(fh(dt), 1),
            s: limit_1.default(0, fs(dt), 1),
            l: limit_1.default(0, fl(dt), 1),
            a: limit_1.default(0, fa(dt), 1)
        });
        return utils_1.FillLine(color);
    };
}
exports.default = FillHSLA;
//# sourceMappingURL=FillHSLA.js.map

/***/ }),

/***/ "./node_modules/@plix-effect/core/dist/effects/FillRGBA.js":
/*!*****************************************************************!*\
  !*** ./node_modules/@plix-effect/core/dist/effects/FillRGBA.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
FillRGBA.meta = {
    name: "FillRGBA",
    description: "Fill with color generated by (r,g,b,a) values",
    paramNames: ["red", "green", "blue", "alpha"],
    paramTypes: ["timing", "timing", "timing", "timing"],
    paramDescriptions: ["red channel (0-255)", "green channel (0-255)", "blue channel (0-255)", "alpha channel (0-1)"],
    defaultValues: [["linear", 0, 255], ["linear", 255, 0], ["linear", 64, 192], ["linear", 0.5, 1]],
    paramParse: [parseTypes_1.TIMING_FUNCTION, parseTypes_1.TIMING_FUNCTION, parseTypes_1.TIMING_FUNCTION, parseTypes_1.TIMING_FUNCTION]
};
function FillRGBA(fr, fg, fb, fa) {
    return function (time, duration) {
        var dt = time / duration;
        var color = Color_1.fromRgba({
            r: posMod_1.default(fr(dt), 256) | 0,
            g: posMod_1.default(fg(dt), 256) | 0,
            b: posMod_1.default(fb(dt), 256) | 0,
            a: limit_1.default(0, fa(dt), 1)
        });
        return utils_1.FillLine(color);
    };
}
exports.default = FillRGBA;
//# sourceMappingURL=FillRGBA.js.map
...
var FillRGBA_1 = __webpack_require__(/*! ./FillRGBA */ "./node_modules/@plix-effect/core/dist/effects/FillRGBA.js");
Object.defineProperty(exports, "FillRGBA", ({ enumerable: true, get: function () { return FillRGBA_1.default; } }));
var FillHSLA_1 = __webpack_require__(/*! ./FillHSLA */ "./node_modules/@plix-effect/core/dist/effects/FillHSLA.js");
Object.defineProperty(exports, "FillHSLA", ({ enumerable: true, get: function () { return FillHSLA_1.default; } }));
...
function BlendFilters(filters, opacity, blender) {
    var blendNormal = Blend_1.default(opacity, blender);
...
/***/ "./node_modules/@plix-effect/core/dist/filters/Parallel.js":
/*!*****************************************************************!*\
  !*** ./node_modules/@plix-effect/core/dist/filters/Parallel.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Parallel.meta = {
    name: "Parallel",
    description: "Apply filters in parallel",
    paramNames: ["filters"],
    paramTypes: ["array:filter"],
    paramParse: [parseTypes_1.ARRAY_OF(parseTypes_1.FILTER)],
    paramDescriptions: ["list of filters"],
...
function Parallel(filters) {
    return function (effect) {
        var results = [];
        for (var _i = 0, filters_1 = filters; _i < filters_1.length; _i++) {
            var filter = filters_1[_i];
            results.push(filter(effect));
        }
        return Chain_1.default(results);
    };
}
...
var Parallel_1 = __webpack_require__(/*! ./Parallel */ "./node_modules/@plix-effect/core/dist/filters/Parallel.js");
Object.defineProperty(exports, "Parallel", ({ enumerable: true, get: function () { return Parallel_1.default; } }));
//# sourceMappingURL=index.js.map
...
function constructEffect(effectConstructor, jsonParams, parserData) {
    ...
    var defaultValues = effectConstructor.meta.defaultValues;
    var params = parseEffectParameters(parsers, defaultValues, jsonParams, parserData);
    return effectConstructor.apply(void 0, params);
}
function parseEffectParameters(parsers, defaultValues, jsonParams, parserData) {
    return parsers.map(function (parser, i) {
        var jsonParam = jsonParams[i];
        if (jsonParam === undefined)
            jsonParam = defaultValues[i];
...
function constructFilter(filterConstructor, jsonParams, parserData) {
    ...
    var defaultValues = filterConstructor.meta.defaultValues;
    var params = parseFilterParameters(parsers, defaultValues, jsonParams, parserData);
    return filterConstructor.apply(void 0, params);
}
function parseFilterParameters(parsers, defaultValues, jsonParams, parserData) {
    return parsers.map(function (parser, i) {
        var jsonParam = jsonParams[i];
        if (jsonParam === undefined)
            jsonParam = defaultValues[i];
